...
DEFAULT_KEYWORDS: list[str] = [
    ...
    "crm", "нужна crm", "crm-систем", "срм",
    "erp", "нужна erp", "erp-систем",
    "saas",
...
# Их наличие на доске-классифайде сразу отсекает объявление (даже если есть
# рекламный крючок «Нужен сайт? — Создам!»).
OFFER_INDICATORS: list[str] = [
    ...
    "сверстаю", "сверстаем", "оказываю услуги", "оказываем услуги",
    "предоставляю услуги", "предоставляем услуги",
    "наша компания", "наша студия", "веб-студия", "веб студия", "web-студия",
    "портфолио", "мои услуги", "наши услуги", "мои работы", "наши работы",
    "услуги по разработке", "услуги веб", "услуги программиста", "услуги дизайнер",
    "обращайтесь", "закажите", "недорого", "по низким ценам",
    "цена от", "стоимость от", "качественно и в срок", "быстро и качественно",
    "любой сложности", "прайс", "расценк", "заказы принимаю", "лет на рынке",
    "на связи 24", "пишите в личку", "пишите в лс",
    # ---- English ----
...
# с опытом»), и в рекламе. Отсекают только вместе с отсутствием запроса на
# обычных биржах; на классифайдах их одних НЕ достаточно для отсева.
OFFER_WEAK_INDICATORS: list[str] = [
    "опыт", "стаж", "гарантия", "работаю с", "работаем с", "профессиональн",
    "years of experience", "tajribali",
]

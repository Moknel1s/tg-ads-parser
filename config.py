...
DEFAULT_KEYWORDS: list[str] = [
    ...
    "saas",
    "телеграм-бот", "телеграм бот", "telegram бот", "чат-бот",
    "бот для бизнеса", "бот для автоматизации",
...
# Признаки того, что речь всё-таки про разработку — перебивают стоп-слова.
